    ...
    if ($result) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($categoriaActual == 1) {
                // Consultar la lista de usuarios activos a cambiar la categoria de Admistrador a Usuario
                $queryUsuarios = "SELECT Usuario, Nombre, Apellido FROM usuarios WHERE Categoria = 1 AND Activo = 1 AND Usuario != '$usuarioActual'";
                ...
                <html lang="es">
                    <head>
                        ...
                        <title>Seleccionar Usuario para Cambiar a Usuario</title>
                        <style>
                            body {
                    ...
                    <body>
                        <div class="containerNuevoUsuario">
                            ...
                            <?php endif; ?>
                            <form action="ProcesarCambioAdUs.php" method="post">
                                <h3 style="margin:auto;">Cambio de Admistrador a Usuario</h3>
                                <br>
                                <select name="usuario">
                                    <?php
