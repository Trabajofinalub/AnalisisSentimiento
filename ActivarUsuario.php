    ...
    if ($result) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($categoriaActual == 1) {
                // Consultar la lista de usuarios activos para activar
                $queryUsuarios = "SELECT Usuario, Nombre, Apellido FROM usuarios WHERE Activo = 0";
                ...
                <html lang="es">
                    <head>
                        ...
                        <title>Seleccionar Usuario para activar</title>
                        <style>
                            body {
                    ...
                    <body>
                        <div class="containerNuevoUsuario">
                            ...
                            <?php endif; ?>
                            <form action="ProcesarActivacion.php" method="post">
                                <h3 style="margin:auto;">Activación de Usuario</h3>
                                <br>
                                <select name="usuario">
                                    <?php
                                ...
                                <hr>
                                <div class="botones">
                                    <input type="submit" value="Activación de Usuario">
